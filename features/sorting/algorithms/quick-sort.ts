...
function partition(array: number[], begin: number, finish: number, animations: AnimationArrayType) {
  let i = begin;
  let j = finish + 1;
...
function runQuickort(array: number[], begin: number, finish: number, animations: AnimationArrayType) {
  if (begin < finish) {
